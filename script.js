function printpdf() {
    // Hide all buttons and checkboxes except "Download" and "Home"
    var downloadButton = document.getElementById("cmd");
    var homeButton = document.querySelector(".navbtn");
    
    const allButtons = document.querySelectorAll("button");
    allButtons.forEach(button => {
        if (button !== downloadButton && button !== homeButton) {
    ...
    html2pdf(content, {
        ...
        onAfterDownload: function () {
            // Show all buttons and checkboxes after PDF generation
            allButtons.forEach(button => {
...
// Define other JavaScript functions for adding and removing resume sections here

// Define your saveresume function if needed

  function addedu() {
    const head = document.createElement('div');
    document.getElementById("education").appendChild(head);
    head.innerHTML = ('<div class="edublock"><span><input type="checkbox" class="input-checkbox"></span><span class="education-head" contenteditable="true">YOUR DEGREE</span><div ><span contenteditable="true">Institute name</span> - <span contenteditable="true">Passing Year</span> - <span contenteditable="true">Percentage</span></div></div>');
    saveresume();
  }
